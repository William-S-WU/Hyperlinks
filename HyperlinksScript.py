...
print("Folders created, download links saved, files downloaded, cleanup completed successfully!")
# Call cleanup function at the end of processing all files
remove_zero_byte_files_and_empty_dirs(directory)
print("Clean up of empty files and folders compleate")
